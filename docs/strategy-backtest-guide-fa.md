...
نکته سشن: پیش‌فرض، داده به ساعت ۱۲:۰۰ تا ۱۸:۰۰ تهران در روزهای شنبه تا چهارشنبه محدود می‌شود. `fill_session: true` هر ثانیه این بازه را روی روزهای دارای داده پر می‌کند و سنگین است. برای تست اول `fill_session: false` بگذار.
