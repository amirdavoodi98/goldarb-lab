"""Gold-fund universe used by pair strategies and 1s backtests."""

from __future__ import annotations

# ins_code values match fetch_data/gold_funds.py / Lab fund meta.
GOLD_FUNDS = {
...
GOLD_FUND_SYMBOLS = tuple(GOLD_FUNDS)

__all__ = ["GOLD_FUNDS", "GOLD_FUND_SYMBOLS"]
